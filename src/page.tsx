...
<title>NOVA — مساعدك الذكي</title>
<meta name="description" content="NOVA: منصة ذكاء اصطناعي متقدمة بذاكرة طويلة المدى وشخصيات متعددة">
...
<div id="app" class="flex h-[100dvh] overflow-hidden">
  ...
  <aside id="sidebar" class="sidebar flex flex-col w-[290px] shrink-0 bg-[#0f131b] border-e border-white/5">
    <header class="p-4 flex items-center justify-between">
      <a href="/" class="flex items-center gap-2.5">
        ...
        <span class="font-extrabold text-lg tracking-tight">NOVA<span class="text-violet-400">.</span></span>
      </a>
    ...
    <footer class="p-3 border-t border-white/5 space-y-1">
      ...
      <button id="btn-about" class="side-link"><i class="fas fa-circle-info text-cyan-400"></i><span>عن NOVA</span></button>
    </footer>
  </aside>
  ...
  <main class="flex-1 flex flex-col min-w-0 relative">
    <header class="topbar flex items-center gap-2 px-3 sm:px-5 h-14 border-b border-white/5 bg-[#0b0e14]/80 backdrop-blur sticky top-0 z-20">
      ...
      <div class="relative">
        <button id="persona-btn" class="chip"><i id="persona-icon" class="fas fa-wand-magic-sparkles"></i><span id="persona-name">نوفا</span><i class="fas fa-chevron-down text-[10px] opacity-60"></i></button>
    ...
    <section id="messages" class="flex-1 overflow-y-auto">
      <div id="welcome" class="max-w-3xl mx-auto px-4 pt-10 sm:pt-20 pb-10">
        <div class="text-center mb-10">
          ...
          <h1 class="text-3xl sm:text-4xl font-extrabold mb-3">أهلاً، أنا <span class="grad-text">NOVA</span></h1>
          <p class="text-slate-400 text-base sm:text-lg">مساعد ذكاء اصطناعي متقدم بذاكرة طويلة المدى. أفكر، أحلل، أبرمج، وأكتب — بالعربي والإنجليزي.</p>
        </div>
    ...
    <footer class="composer-wrap">
      <div class="max-w-3xl mx-auto px-3 sm:px-4 pb-3 sm:pb-5">
        <div class="composer">
          <textarea id="composer-input" rows="1" placeholder="اكتب رسالتك... (Enter للإرسال، Shift+Enter لسطر جديد)"></textarea>
        ...
        <p class="text-center text-[11px] text-slate-500 mt-2">NOVA قد يخطئ أحياناً — تحقق من المعلومات المهمة.</p>
      </div>
    </footer>
  </main>
</div>
